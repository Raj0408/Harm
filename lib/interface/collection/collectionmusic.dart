...
class CollectionMusicState extends State<CollectionMusic>
  ...
  Color coulorT = Colors.red;
  Color coulorA = Colors.red;
  Color coulorS = Colors.red;
  Color coulorP = Colors.red;
  ...
  Widget build(BuildContext context) {
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () => setState(() {
                                    this.index = 0;
                                    coulor = Colors.white;
                                    coulorA = Colors.transparent;
                                    coulorT = Colors.transparent;
                                    coulorS = Colors.transparent;
                                    coulorP = Colors.transparent;
                                    // coulor = kcolor;
                                  }),
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.0),color: coulor),
                                    // color: coulor,
                                    height: 40.0,
                                    padding:
                                        EdgeInsets.symmetric(horizontal: 4.0),
    ...
    onTap: () => setState(() {
      this.index = 1;
      coulor = Colors.transparent;
      coulorT = Colors.white;
      coulorA = Colors.transparent;
      coulorS = Colors.transparent;
      coulorP = Colors.transparent;
    }),
                                  ...
                                  // splashColor: Colors.blue[100],
                                  child: Container(
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.0),color: coulorT),
                                    height: 40.0,
                                    padding:
                                        EdgeInsets.symmetric(horizontal: 4.0),
                                    alignment: Alignment.center,
                              ...
                              InkWell(
                                ...
                                // splashColor: Colors.blue[100],
                                child: Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.0),color: coulorA),
                                  height: 40.0,
                                  padding:
                                      EdgeInsets.symmetric(horizontal: 4.0),
                                  alignment: Alignment.center,
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.0),color: coulorS),
                                  height: 40.0,
                                  padding:
                                      EdgeInsets.symmetric(horizontal: 4.0),
                                  alignment: Alignment.center,
                              ...
                              InkWell(
                                ...
                                onTap: () => setState(() {
                                  ...
                                  coulorA = Colors.transparent;
                                  coulorS = Colors.transparent;
                                  coulorP = Colors.white;
                                }),
                                // highlightColor: Colors.blue,
                                // splashColor: Colors.blue[100],
                                child: Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.0),color: coulorP),
                                  height: 40.0,
                                  padding:
                                      EdgeInsets.symmetric(horizontal: 4.0),
                                  alignment: Alignment.center,
